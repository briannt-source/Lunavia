...
export default function BrowseToursPageGuideView() {
  return (
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f4] bg-white px-10 py-3 shadow-sm dark:bg-[#1A2633] dark:border-b-gray-700">
        ...
        <div className="flex flex-1 justify-end gap-8">
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" className="relative text-[#617589] hover:text-[#111418] dark:text-gray-400">
              <Bell className="h-5 w-5" />
              <span className="absolute top-0 right-0 h-2 w-2 rounded-full bg-red-500"></span>
            </Button>
            <div className="relative w-10 h-10 rounded-full border-2 border-white shadow-sm cursor-pointer overflow-hidden">
              <Image
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuC1Xs_RQs5P7I3TMmICDTzOqvOWwzyrn8fAnFw5D7LXJi4iLfyA7v--IGGNiKL1jsB5j1jgA4ys-DKpdkfAWYbQcptB9BfY-w0KqsrbZcS9auMi8i3TTDrzCRji9hsdTjJqLNmJF6t5QlJJteBG3ESdEuXHJeDa2rbgaun2HCKE0camzhixWHBzFs5KnlGfjVBGFiTNK8SYJasiA2AvgQXe9pG0pVmf8tY2GpfgTEwt83xeeIKQ6axeTcW8P9HO59uRZsIUKw-VZg"
        ...
        <div className="mx-auto max-w-[1200px] flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[#617589] text-base font-normal leading-normal dark:text-gray-400">
              Khám phá và ứng tuyển vào các tour phù hợp với chuyên môn và lịch trình của bạn.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4 rounded-xl bg-white p-5 shadow-sm dark:bg-[#1A2633]">
            ...
            <div className="flex flex-wrap gap-3 items-center">
              ...
              <Button
                variant="outline"
                className="group flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-lg border border-[#e5e7eb] bg-white hover:bg-gray-50 px-4 transition-all dark:bg-[#232F3E] dark:border-gray-600 dark:hover:bg-gray-700"
              >
                <MapPin className="h-5 w-5 text-[#617589] dark:text-gray-400" />
                <p className="text-[#111418] text-sm font-medium leading-normal dark:text-gray-200">Thành phố</p>
                <ChevronDown className="h-5 w-5 text-[#617589] dark:text-gray-400" />
              </Button>
              <Button
                variant="outline"
                className="group flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-lg border border-[#e5e7eb] bg-white hover:bg-gray-50 px-4 transition-all dark:bg-[#232F3E] dark:border-gray-600 dark:hover:bg-gray-700"
              >
                <Calendar className="h-5 w-5 text-[#617589] dark:text-gray-400" />
              ...
              <Button
                ...
                className="group flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-lg border border-[#e5e7eb] bg-white hover:bg-gray-50 px-4 transition-all dark:bg-[#232F3E] dark:border-gray-600 dark:hover:bg-gray-700"
              >
                <Wallet className="h-5 w-5 text-[#617589] dark:text-gray-400" />
              ...
              <Button variant="link" className="text-sm font-medium text-primary hover:underline">
                Xóa bộ lọc
              </Button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Select>
                <SelectTrigger className="bg-transparent text-sm font-medium text-[#111418] focus:outline-none cursor-pointer dark:text-white border-none">
                  <SelectValue placeholder="Mới nhất" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="newest">Mới nhất</SelectItem>
                  <SelectItem value="highest-salary">Lương cao nhất</SelectItem>
                  <SelectItem value="nearest-date">Ngày gần nhất</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-5">
            ...
            <div className="group relative flex flex-col items-stretch justify-start rounded-xl border border-transparent hover:border-primary/20 bg-white p-4 shadow-sm transition-all hover:shadow-md dark:bg-[#1A2633] dark:hover:border-primary/40 sm:flex-row sm:items-start">
              ...
              <div className="relative w-full sm:w-48 md:w-64 h-48 sm:h-auto shrink-0 bg-center bg-no-repeat bg-cover rounded-lg overflow-hidden">
                <Image
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCozHXDoHHeUXthNVw2v-GQLD6h2-TkTxvMj23CHkIs4FhIAMaceyNcwviErAbrsZxVrzxDaaC5bolTQMRkVhr49snMCwgoAFXZAK54SpYzfZihWpcmn8C-g2j0up_sMvnQCxZ7qYkX59v0xEnri_XyAoq_kyEidU3_PPzsGLP5liURjmxIkXqwCrbXbymj7y-jb1LR3Jb1ULiSNBp9jARibW1t8oLBFgT3lHS54UuUUj2g-WAzT8Xat6ryqTORdhhr_FuoBExnAQ"
                  alt="Scenic view of Ha Long Bay limestone karsts on water"
                  fill
                  className="object-cover"
                />
              ...
              <div className="flex w-full grow flex-col justify-between gap-3 p-2 sm:px-6 sm:py-2">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <div className="relative size-5 rounded-full bg-gray-200 overflow-hidden">
                      <Image
                    ...
                    <Verified className="h-4 w-4 text-blue-500" title="Verified Operator" />
                  </div>
                </div>
                {/* Logistics */}
            ...
            <div className="group relative flex flex-col items-stretch justify-start rounded-xl border border-transparent hover:border-primary/20 bg-white p-4 shadow-sm transition-all hover:shadow-md dark:bg-[#1A2633] dark:hover:border-primary/40 sm:flex-row sm:items-start">
              <div className="relative w-full sm:w-48 md:w-64 h-48 sm:h-auto shrink-0 bg-center bg-no-repeat bg-cover rounded-lg overflow-hidden">
                <Image
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuC8i3wNUHJGYy8LyAdq2EVcnzCI022VzsgHL9x97tDlV0NmnM2IjikOE5WDZlNioRll7-14J-IOJJLIdKmi1A_ATi0DuNbZm1YyccrDFOjLKDZOXwzCNnMygICZ22iM3k02zbVOL9lZN2SWMOTzzAWdhP8rehi7S8uVYxAGCEJosPfIH4NATkjDjnFatrrJhKt14s2IGH16dyJiAADr04o1OWVwM9FXcwEozKQBnRSDgr_hTKt0SfhlSNnx31DpXUpzmlDufxR9vw"
                  alt="Golden Bridge held by stone hands in Da Nang"
                  fill
                  className="object-cover"
                />
              </div>
            ...
            <div className="group relative flex flex-col items-stretch justify-start rounded-xl border border-transparent hover:border-primary/20 bg-white p-4 shadow-sm transition-all hover:shadow-md dark:bg-[#1A2633] dark:hover:border-primary/40 sm:flex-row sm:items-start">
              <div className="relative w-full sm:w-48 md:w-64 h-48 sm:h-auto shrink-0 bg-center bg-no-repeat bg-cover rounded-lg overflow-hidden">
                <Image
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCgwlyDlROpi8Riv7ViZb4p4MN6SCtH8lhTsskURtkhVmbhw5R2dgiM3fbuEWVewdYWqKZTTljmySqCkDVoz7sJTqo3amgi2JsgPdBGj2aYTGOWkIyUP03bEkBi1waNS_iURZbOXHp0DkLfFAV04CZQDp1k3L99nYrsnPMVxUkaxTsQroGeVMaxS-5272QAxUSG73Ekj1346ELA1o6Tdk4SmNuOPtI2bVUVYqYUGz1VcwX5Sbr5G9rli_8LZOzbfOuYOKnXMnnjLA"
                  alt="Terraced rice fields in Sapa valley"
                  fill
                  className="object-cover"
                />
              </div>
          ...
          <div className="flex justify-center mt-4 mb-8">
            <nav aria-label="Pagination" className="flex items-center gap-1">
              <Button
                variant="outline"
                className="flex h-10 w-10 items-center justify-center rounded-lg border border-transparent text-[#617589] hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700"
              >
