    ...
    return (
        <div className="overflow-hidden bg-[#FDFBF7]">
            ...
            <section className="pt-24 pb-20 text-center px-6">
                <span className="inline-block px-4 py-1.5 rounded-full bg-blue-50 text-blue-600 text-[10px] font-bold tracking-wide mb-6 uppercase">
                    Public Help Center
                </span>
                ...
                <div className="max-w-xl mx-auto relative flex shadow-lg rounded-full">
                    ...
                    />
                    <button className="absolute right-2 top-2 bottom-2 bg-blue-600 text-white px-6 rounded-full text-sm font-semibold hover:bg-blue-700 transition">
                        Search
                    </button>
                </div>
            </section>
            ...
            <section className="py-12 px-6">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm text-center hover:shadow-lg transition cursor-pointer group">
                        <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center text-blue-600 mx-auto mb-4 group-hover:scale-110 transition">
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm text-center hover:shadow-lg transition cursor-pointer group">
                        <div className="w-12 h-12 bg-indigo-50 rounded-full flex items-center justify-center text-indigo-600 mx-auto mb-4 group-hover:scale-110 transition">
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto flex flex-col md:flex-row gap-16">
                ...
                <div className="flex-grow">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <button className="bg-blue-50 p-1 rounded hover:bg-blue-100 text-blue-600">
                    ...
                    {/* CTA Block */}
                    <div className="bg-blue-50 rounded-3xl p-8 mt-12 flex items-center justify-between">
                        <div>
                            <div className="flex items-center gap-2 mb-2">
                                <span className="text-blue-600 font-bold flex items-center gap-2"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg> The Lunavia Charter</span>
                            </div>
                            ...
                            <Link href="#" className="text-blue-600 font-semibold text-sm hover:underline">Read the Neutrality Charter →</Link>
                        </div>
                        <div className="hidden md:block opacity-50">
                            {/* Abstract Decorative Element */}
                            <div className="w-24 h-24 rounded-full border-4 border-blue-200 border-dashed animate-spin-slow"></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-gradient-to-b from-slate-50 to-blue-50 py-24 text-center mt-20 relative overflow-hidden border-t border-slate-200">
                <div className="max-w-2xl mx-auto px-6 relative z-10">
                    ...
                    <div className="flex items-center justify-center gap-4">
                        <Link href="#" className="px-8 py-3 bg-blue-600 text-white font-bold rounded-full hover:bg-blue-700 transition shadow-lg shadow-blue-600/25">Contact Support</Link>
