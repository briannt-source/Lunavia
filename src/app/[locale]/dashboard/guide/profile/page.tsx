        ...
        return (
            ...
            >
                <div className="max-w-lg mx-auto text-center py-16">
                    ...
                    <a href="/dashboard/guide/profile" className="px-4 py-2 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-emerald-700 transition">Reload Page</a>
                </div>
            </BaseDashboardLayout>
        );
    }
