...
export default function OperatorMarketplacePage() {
    ...
    return (
        <div className="space-y-6">
            {/* Header */}
            <div>
                <h1 className="text-2xl font-bold text-gray-900">Discover Guides</h1>
                <p className="text-sm text-gray-500 mt-0.5">Find and invite qualified tour guides for your tours</p>
            </div>
