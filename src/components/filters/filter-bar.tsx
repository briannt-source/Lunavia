  ...
  return (
    <FormField className="h-12 w-full">
      <div className="flex w-full flex-1 items-stretch rounded-lg h-full border border-[#e5e7eb] focus-within:border-primary focus-within:ring-1 focus-within:ring-primary overflow-hidden dark:border-gray-600">
        ...
        <input className="flex w-full min-w-0 flex-1 resize-none overflow-hidden text-[#111418] focus:outline-0 bg-white placeholder:text-[#9ca3af] px-4 text-base font-normal leading-normal dark:bg-[#232F3E] dark:text-white" placeholder="Tìm theo tên tour, mã tour..." />
        <Button asChild>
