# PowerShell script to apply enhanced reviews migration
# Usage: .\scripts\apply-enhanced-reviews-migration.ps1

Write-Host "Applying Enhanced Reviews Migration..." -ForegroundColor Cyan
...
$migrationFile = Join-Path (Join-Path (Join-Path (Join-Path (Join-Path $PSScriptRoot "..") "prisma") "migrations") "20250115000008_enhance_reviews") "migration.sql"
