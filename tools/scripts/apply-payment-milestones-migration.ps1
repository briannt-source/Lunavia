# PowerShell script to apply payment milestones migration
# Usage: .\scripts\apply-payment-milestones-migration.ps1

Write-Host "Applying Payment Milestones Migration..." -ForegroundColor Cyan
...
$migrationFile = Join-Path (Join-Path (Join-Path (Join-Path (Join-Path $PSScriptRoot "..") "prisma") "migrations") "20250115000007_add_payment_milestones") "migration.sql"
