# PowerShell script to apply enhanced SOS system migration
# Usage: .\scripts\apply-enhanced-sos-migration.ps1

Write-Host "Applying Enhanced SOS System Migration..." -ForegroundColor Cyan
...
$migrationFile = Join-Path (Join-Path (Join-Path (Join-Path (Join-Path $PSScriptRoot "..") "prisma") "migrations") "20250115000011_enhanced_sos_system") "migration.sql"
