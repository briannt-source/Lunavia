# PowerShell script to apply platform fee and standby fields migration
# This script reads DATABASE_URL from .env and applies the SQL migration

$ErrorActionPreference = "Stop"

Write-Host "Applying platform fee and standby fields migration..." -ForegroundColor Cyan
...
$migrationDir = Join-Path $migrationDir "20250115000004_add_platform_fee_and_standby_fields"
