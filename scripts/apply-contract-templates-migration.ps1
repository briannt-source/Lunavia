# PowerShell script to apply contract templates migration
# Usage: .\scripts\apply-contract-templates-migration.ps1

Write-Host "Applying Contract Templates & E-Signature Migration..." -ForegroundColor Cyan
...
$migrationFile = Join-Path (Join-Path (Join-Path (Join-Path (Join-Path $PSScriptRoot "..") "prisma") "migrations") "20250115000009_contract_templates_esignature") "migration.sql"
